...
enum TypoStyle: Int, CaseIterable {
    ...
    case title1             // 18pt / semibold / -0.54 / 27
    case title2             // 16pt / semibold / -0.48 / 22.4
    case title3             // 14pt / semibold / -0.42 / 19.6
    case title4             // 12pt / semibold / -0.36 / 14.4
    case title5             // 10pt / semibold / -0.3 / 12
...
extension TypoStyle {
    private var fontDescription: FontDescription {
        ...
        case .title1:       return FontDescription(font: .SemiBold, size: 18)
        case .title2:       return FontDescription(font: .SemiBold, size: 16)
        case .title3:       return FontDescription(font: .SemiBold, size: 14)
        case .title4:       return FontDescription(font: .SemiBold, size: 12)
        case .title5:       return FontDescription(font: .SemiBold, size: 10)
    ...
    public var labelDescription: LabelDescription {
        ...
        case .title1:       return LabelDescription(kern: -0.54, lineHeight: 27)
        case .title2:       return LabelDescription(kern: -0.48, lineHeight: 22.4)
        case .title3:       return LabelDescription(kern: -0.42, lineHeight: 19.6)
        case .title4:       return LabelDescription(kern: -0.36, lineHeight: 14.4)
        case .title5:       return LabelDescription(kern: -0.3, lineHeight: 12)
